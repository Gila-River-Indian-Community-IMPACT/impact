...
<f:facet name="nodeStamp">
	<af:commandMenuItem text="#{foo.label}" action="#{foo.getOutcome}"
		...
		onclick="if (#{complianceReport.editMode}) { alert('Please save or cancel your changes'); return false; }">
...
<f:facet name="location">
	<af:panelGroup layout="horizontal"
		rendered="#{!complianceReport.readOnlyReport}">
		<af:commandLink text="Task - #{complianceReport.task.taskDescription}"
			action="complianceDetail" />
