					...
					<af:table id="emissionsOffsets" 
						...
						<af:column id="facilityId" headerText="Facility ID" width="5%"
							...
							<af:panelHorizontal valign="middle" halign="left">
								<af:inputText label="Facility ID"
									readOnly="true" 
									value="#{emissionsOffset.facilityId}" />
							</af:panelHorizontal>
						</af:column>
						...
						<af:column id="facilityName" headerText="Facility Name" width="12%"
							...
							<af:panelHorizontal valign="middle" halign="left">
								<af:inputText label="Facility Name"
									readOnly="true"
									value="#{emissionsOffset.facilityName}" />
							</af:panelHorizontal>
						</af:column>
						...
						<af:column id="permitNumber" headerText="Permit Number" width="5%"
							...
							<af:panelHorizontal valign="middle" halign="left">
								<af:inputText label="Permit Number"
									readOnly="true" 
									value="#{emissionsOffset.permitNumber}"	/>
							</af:panelHorizontal>
						</af:column>
						...
						<af:column id="currentOffset" headerText="Current (Tons)" width="5%"
							...
							<af:panelHorizontal valign="middle" halign="right">
								<af:inputText label="Current (Tons)" 
									readOnly="true"
						...
						<af:column id="delta" headerText="Delta (Tons)" width="5%"
							...
							<af:panelHorizontal valign="middle" halign="right">
								<af:inputText label="Delta (Tons)"
									readOnly="true"
									value="#{emissionsOffset.delta}" >
									<af:convertNumber type="number" pattern="###,###.###" minFractionDigits="3"/>
								</af:inputText>	
							</af:panelHorizontal>
						</af:column>
						...
						<af:column id="offsetMultiple" headerText="Emissions Increase Multiplier"
							...
							formatType="number">
							<af:panelHorizontal valign="middle" halign="right">
								<af:inputText label="Emissions Increase Multiplier"
									readOnly="true"
						...
						<af:column id="offsetAmount" headerText="Offset Used(+) or Generated(-) (Tons)" width="5%"
							...
							<af:panelHorizontal valign="middle" halign="right">
								<af:inputText label="Offset Used(+) or Generated(-) (Tons)"
									readOnly="true"
