...
<f:view>
  <af:document id="body" onmousemove="#{infraDefs.iframeResize}" onload="#{infraDefs.iframeReload}" title="Preliminary Proposed">
                  ...
                  <af:panelGroup>
                    <af:panelForm labelWidth="44%" rows="1" maxColumns="2"
                      ...
                      <af:selectInputDate label="Issuance date :"
                        readOnly="#{! permitDetail.editMode}"
                        value="#{permitDetail.permit.pppIssueDate}" > <af:validateDateTimeRange minimum="1900-01-01"/></af:selectInputDate>
                      <af:selectOneChoice label="Company review outcome :"
                        readOnly="#{! permitDetail.editMode}"
                        value="#{permitDetail.permit.usepaOutcomeCd}">
                        <mu:selectItems
                          value="#{permitReference.companyOutcomeDefs}" />
                      </af:selectOneChoice>
                      <af:selectInputDate label="Certified mail receipt date :"
                        readOnly="#{! permitDetail.editMode}" value="" > <af:validateDateTimeRange minimum="1900-01-01"/></af:selectInputDate>
                    ...
                    <afh:rowLayout halign="center"
                      rendered="#{!permitDetail.editMode && permitDetail.permit.pppIssuanceStatusCd != permitReference.issuanceStatusIssued}">
                      <af:panelButtonBar>
