...
<af:table value="#{companyProfile.sourceCmpFacWrapper}"
	binding="#{companyProfile.sourceCmpFacWrapper.table}" bandingInterval="1"
	...
	<af:column sortProperty="c01" sortable="true" noWrap="true"
		...
		<af:commandLink action="#{facilityProfile.submitProfile}"
			text="#{cmpFac.facilityId}" disabled="true">
