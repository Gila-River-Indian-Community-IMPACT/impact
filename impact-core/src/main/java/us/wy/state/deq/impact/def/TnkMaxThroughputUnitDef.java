...
public class TnkMaxThroughputUnitDef {

	// ****************** Variables *******************
	private static final String defName = "TnkMaxThroughputUnitDef";
	private static final String tableName = "CM_TNK_MAX_THROUGHPUT_UNIT_DEF";
