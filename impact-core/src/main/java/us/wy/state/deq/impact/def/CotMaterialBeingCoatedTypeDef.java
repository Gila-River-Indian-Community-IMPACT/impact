...
public class CotMaterialBeingCoatedTypeDef {
	
	//****************** Variables ******************* 
    private static final String defName = "CotMaterialBeingCoatedTypeDef";
    private static final String tableName = "CM_COT_MATERIAL_BEING_COATED_TYPE_DEF";
