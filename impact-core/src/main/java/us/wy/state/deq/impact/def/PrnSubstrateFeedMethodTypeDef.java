...
public class PrnSubstrateFeedMethodTypeDef {
	
	//****************** Variables ******************* 
    private static final String defName = "PrnSubstrateFeedMethodTypeDef";
    private static final String tableName = "CM_PRN_SUBSTRATE_FEED_METHOD_TYPE_DEF";
