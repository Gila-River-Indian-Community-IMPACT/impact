...
public class DryTypeOfOperationTypeDef {
	
	//****************** Variables ******************* 
    private static final String defName = "DryTypeOfOperationTypeDef";
    private static final String tableName = "CM_DRY_TYPE_OF_OPERATION_TYPE_DEF";
