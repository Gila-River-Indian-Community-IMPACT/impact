...
public class OrdExplosiveTypeDef {
	
	//****************** Variables ******************* 
    private static final String defName = "OrdExplosiveTypeDef";
    private static final String tableName = "CM_ORD_EXPLOSIVE_TYPE_DEF";
