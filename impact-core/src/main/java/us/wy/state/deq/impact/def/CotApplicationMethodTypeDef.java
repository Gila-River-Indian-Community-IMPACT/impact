...
public class CotApplicationMethodTypeDef {
	
	//****************** Variables ******************* 
    private static final String defName = "CotApplicationMethodTypeDef";
    private static final String tableName = "CM_COT_APPLICATION_METHOD_TYPE_DEF";
