...
public class CmxMaxProductionRateUnitsDef {
	
	//****************** Variables ******************* 	
    private static final String defName = "CmxMaxProductionRateUnitsDef";
    private static final String tableName = "CM_CMX_MAX_PRODUCTION_RATE_UNITS_DEF";
