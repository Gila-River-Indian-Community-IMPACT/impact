...
public class RemContaminatedMaterialTypeDef {
	
	//****************** Variables ******************* 
    private static final String defName = "RemContaminatedMaterialTypeDef";
    private static final String tableName = "CM_REM_CONTAMINATED_MATERIAL_TYPE_DEF";
