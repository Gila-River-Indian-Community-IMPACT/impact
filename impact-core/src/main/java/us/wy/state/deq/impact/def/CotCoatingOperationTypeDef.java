...
public class CotCoatingOperationTypeDef {
	
	//****************** Variables ******************* 
    private static final String defName = "CotCoatingOperationTypeDef";
    private static final String tableName = "CM_COT_COATING_OPERATION_TYPE_DEF";
