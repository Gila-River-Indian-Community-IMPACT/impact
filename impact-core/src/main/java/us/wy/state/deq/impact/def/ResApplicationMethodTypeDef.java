...
public class ResApplicationMethodTypeDef {
	
	//****************** Variables ******************* 
    private static final String defName = "ResApplicationMethodTypeDef";
    private static final String tableName = "CM_RES_APPLICATION_METHOD_TYPE_DEF";
