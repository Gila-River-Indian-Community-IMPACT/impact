...
public class FlareDesignCapacityUnitsDef {
	
	//****************** Variables ******************* 	
    private static final String defName = "FlareDesignCapacityUnitsDef";
    private static final String tableName = "CM_FLARE_DESIGN_CAPACITY_UNITS_DEF";
