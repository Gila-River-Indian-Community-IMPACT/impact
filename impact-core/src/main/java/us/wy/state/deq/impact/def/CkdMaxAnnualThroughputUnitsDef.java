...
public class CkdMaxAnnualThroughputUnitsDef {
	
	//****************** Variables ******************* 	
    private static final String defName = "CkdMaxAnnualThroughputUnitsDef";
    private static final String tableName = "CM_CKD_MAX_ANNUAL_THROUGHPUT_UNITS_DEF";
