...
public class RemContaminantTypeDef {
	
	//****************** Variables ******************* 
    private static final String defName = "RemContaminantTypeDef";
    private static final String tableName = "CM_REM_CONTAMINANT_TYPE_DEF";
