...
public class AptMaxThroughputUnitsDef {
	
	//****************** Variables ******************* 	
    private static final String defName = "AptMaxThroughputUnitsDef";
    private static final String tableName = "CM_APT_MAX_THROUGHPUT_UNITS_DEF";
