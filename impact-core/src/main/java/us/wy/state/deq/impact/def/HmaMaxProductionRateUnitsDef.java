...
public class HmaMaxProductionRateUnitsDef {
	
	//****************** Variables ******************* 	
    private static final String defName = "HmaMaxProductionRateUnitsDef";
    private static final String tableName = "CM_HMA_MAX_PRODUCTION_RATE_UNITS_DEF";
