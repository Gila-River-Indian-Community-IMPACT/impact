...
public class HeatContentFuelUnitsDef {
	
	//****************** Variables ******************* 
    private static final String defName = "HeatContentFuelUnitsDef";
    private static final String tableName = "CM_HEAT_CONTENT_FUEL_UNITS_DEF";
