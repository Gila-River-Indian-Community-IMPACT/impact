...
public class SecondaryFuelTypeDef {
	
	//****************** Variables ******************* 	
    private static final String defName = "SecondaryFuelTypeDef";
    private static final String tableName = "CM_SECONDARY_FUEL_TYPE_DEF";
