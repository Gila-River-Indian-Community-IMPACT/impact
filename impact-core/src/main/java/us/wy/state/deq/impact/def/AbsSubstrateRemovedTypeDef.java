...
public class AbsSubstrateRemovedTypeDef {
	
	//****************** Variables ******************* 
    private static final String defName = "AbsSubstrateRemovedTypeDef";
    private static final String tableName = "CM_ABS_SUBSTRATE_Removed_TYPE_DEF";
