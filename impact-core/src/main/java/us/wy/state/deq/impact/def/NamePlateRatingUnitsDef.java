...
public class NamePlateRatingUnitsDef {
	
	//****************** Variables ******************* 	
    private static final String defName = "NamePlateRatingUnitsDef";
    private static final String tableName = "CM_NAME_PLATE_RATING_UNITS_DEF";
