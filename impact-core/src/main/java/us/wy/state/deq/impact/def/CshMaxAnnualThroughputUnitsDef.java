...
public class CshMaxAnnualThroughputUnitsDef {
	
	//****************** Variables ******************* 	
    private static final String defName = "CshMaxAnnualThroughputUnitsDef";
    private static final String tableName = "CM_CSH_MAX_ANNUAL_THROUGHPUT_UNITS_DEF";
