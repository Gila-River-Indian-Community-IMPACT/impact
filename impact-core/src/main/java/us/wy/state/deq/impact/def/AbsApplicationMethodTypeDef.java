...
public class AbsApplicationMethodTypeDef {
	
	//****************** Variables ******************* 
    private static final String defName = "AbsApplicationMethodTypeDef";
    private static final String tableName = "CM_ABS_APPLICATION_METHOD_TYPE_DEF";
