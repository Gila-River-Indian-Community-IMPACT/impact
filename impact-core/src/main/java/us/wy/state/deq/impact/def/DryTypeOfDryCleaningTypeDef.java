...
public class DryTypeOfDryCleaningTypeDef {
	
	//****************** Variables ******************* 
    private static final String defName = "DryTypeOfDryCleaningTypeDef";
    private static final String tableName = "CM_DRY_TYPE_OF_DRY_CLEANING_TYPE_DEF";
