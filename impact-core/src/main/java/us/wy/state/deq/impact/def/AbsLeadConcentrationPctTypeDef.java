...
public class AbsLeadConcentrationPctTypeDef {
	
	//****************** Variables ******************* 
    private static final String defName = "AbsLeadConcentrationPctTypeDef";
    private static final String tableName = "CM_ABS_LEAD_CONCENTRATION_PCT_TYPE_DEF";
