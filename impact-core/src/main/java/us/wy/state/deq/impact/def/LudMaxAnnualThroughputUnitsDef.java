...
public class LudMaxAnnualThroughputUnitsDef {
	
	//****************** Variables ******************* 	
    private static final String defName = "LudMaxAnnualThroughputUnitsDef";
    private static final String tableName = "CM_LUD_MAX_ANNUAL_THROUGHPUT_UNITS_DEF";
