...
public class WeldingProcessTypeDef {
	
	//****************** Variables ******************* 
    private static final String defName = "WeldingProcessTypeDef";
    private static final String tableName = "CM_WELDING_PROCESS_TYPE_DEF";
