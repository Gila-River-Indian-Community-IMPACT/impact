...
public class ComplianceAttachmentTvccTypeDef {
    private static final String defName = "ComplianceAttachmentTvccTypeDef";
    ...
    public static DefData getData() {
        ...
        if (data == null) {
            data = new DefData();
            data.loadFromDB("cr_tvcc_attachment_type_def", "tvcc_attachment_type_cd", "tvcc_attachment_type_dsc", "deprecated");
