 ...
 */
public class PAEuPteDeterminationBasisDef {
    
    public static final String OTHERS = "OTH";
    private static final String defName = "PAEuPteDeterminationBasisDef";
    ...
    public static DefData getData() {
        ...
        if (data == null) {
            data = new DefData();
            data.loadFromDB("PA_EU_PTE_DETERMINATION_BASIS_DEF", "PTE_DETERMINATION_BASIS_CD",
