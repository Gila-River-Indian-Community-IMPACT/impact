...
@Repository
public class EmissionUnitTypeORDSQLDAO extends EmissionUnitTypeSQLDAO implements
		EmissionUnitTypeDAO {
	...
	public EmissionUnitType createEmissionUnitType(EmissionUnitType euType)
		...
		ConnectionHandler connHandler = new ConnectionHandler(
				"EmissionUnitTypeSQL.createEmissionUnitTypeORD", false);

		int i = 1;
		connHandler.setInteger(i++, euType.getEmuId());
		connHandler.setString(i++, euType.getTypeOfExplosive());
		connHandler.setString(i++, euType.getTypeOfExplosiveOther());
		connHandler.setInteger(i++, euType.getMaxNumberOfRoundsDetonated());
		connHandler.update();
