...
public class ComplianceAttachmentTestingTypeDef  extends SimpleDef {
    private static final String defName = "ComplianceAttachmentTestingTypeDef";
    ...
    public static DefData getData() {
        ...
        if (data == null) {
            data = new DefData();
            data.loadFromDB("ComplianceReportSQL.retrieveTestingAttachmentTypes", 
                    ComplianceAttachmentTestingTypeDef.class);
