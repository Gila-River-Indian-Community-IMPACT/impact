...
@Repository
public class EmissionUnitTypeSEPSQLDAO extends EmissionUnitTypeSQLDAO implements
		EmissionUnitTypeDAO {
	...
	public EmissionUnitType createEmissionUnitType(EmissionUnitType euType)
		...
		ConnectionHandler connHandler = new ConnectionHandler(
				"EmissionUnitTypeSQL.createEmissionUnitTypeSEP", false);

		int i = 1;
		connHandler.setInteger(i++, euType.getEmuId());
		connHandler.setString(i++, euType.getVesselType());
		connHandler.setString(i++, AbstractDAO.translateBooleanToIndicator(euType.isVesselHeated()));
		connHandler.update();
