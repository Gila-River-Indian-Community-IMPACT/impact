...
@Repository
public class EmissionUnitTypeBVCSQLDAO extends EmissionUnitTypeSQLDAO implements
		EmissionUnitTypeDAO {
	...
	public EmissionUnitType createEmissionUnitType(EmissionUnitType euType)
		...
		ConnectionHandler connHandler = new ConnectionHandler(
				"EmissionUnitTypeSQL.createEmissionUnitTypeBVC", false);

		int i = 1;
		connHandler.setInteger(i++, euType.getEmuId());
		connHandler.setString(i++, euType.getEventType());
