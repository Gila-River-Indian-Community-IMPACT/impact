...
public class CetaPopulateEnforcements extends ValidationBase implements Job {
...
//    Facility curFac = null;
	...
	public CetaPopulateEnforcements() {
        super();
    }
...
//                            curFac = facilityBO().retrieveFacility(cea.facility_id);
//                            if(curFac == null) {
...
//                                break;
//                            }
//                            enforcement.setInspectionClassCd(ea.getFacilityHistory().getInspectionClassCd());
//                        }
...
//                milestones = new ArrayList<EnforcementMilestone>();
                try {
                    while(!CetaEnforceMilestone.eof) {
                        ...
                        //getEnforcementService().createEnforcementMilestone(em);
                    }
                } catch(Exception e) {
                    logger.error("reading milestones got exception", e);
                }
                ...
                try {
                    while(!CetaEnforceNote.eof) {
                        ...
                        //getEnforcementService().createEnforcementNote(en);
                    }
                } catch(Exception e) {
                    logger.error("reading notes got exception", e);
                }
...
//            fh.setInspectionClassCd(InspectionClassDef.NON_HPF);
//        }
//        if(bSM) {
//            foundCnt++;
//            fh.setAirProgramCd(AirProgramDef.SM_FESOP);
//            fh.setInspectionClassCd(InspectionClassDef.FEPTIO);
//        }
//        if(bTV) {
//            foundCnt++;
//            fh.setAirProgramCd(AirProgramDef.TITLE_V);
//            fh.setInspectionClassCd(InspectionClassDef.TV);
//        }
//
...
//            try {
//                FacilityHistList fhl = facilityBO().searchFacilitiesHist(cea.facility_id, cea.actionDate);
//                if(fhl != null) {
//                    fpId = fhl.getFpId();
//                } else {
...
//                    return null;
//                }
//                histFacility = facilityBO().retrieveFacilityProfile(fpId);
