...
@Repository
public class EmissionUnitTypeOZGSQLDAO extends EmissionUnitTypeSQLDAO implements
		EmissionUnitTypeDAO {
	...
	public EmissionUnitType createEmissionUnitType(EmissionUnitType euType)
		...
		ConnectionHandler connHandler = new ConnectionHandler(
				"EmissionUnitTypeSQL.createEmissionUnitTypeOZG", false);

		int i = 1;
		connHandler.setInteger(i++, euType.getEmuId());
		connHandler.setInteger(i++, euType.getMaxOzoneGenerationRate());
		connHandler.update();
		return ret;
	}
}