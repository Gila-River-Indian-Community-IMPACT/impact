...
@Repository
public class EmissionUnitTypeTIMSQLDAO extends EmissionUnitTypeSQLDAO implements
		EmissionUnitTypeDAO {
	...
	public EmissionUnitType createEmissionUnitType(EmissionUnitType euType)
		...
		ConnectionHandler connHandler = new ConnectionHandler(
				"EmissionUnitTypeSQL.createEmissionUnitTypeTIM", false);

		int i = 1;
		connHandler.setInteger(i++, euType.getEmuId());
		connHandler.setInteger(i++, euType.getMaxAmtOfRubberRemoved());
		connHandler.update();
