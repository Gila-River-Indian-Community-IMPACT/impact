...
public class ComplianceAttachmentCemsTypeDef  extends SimpleDef {
    private static final String defName = "ComplianceAttachmentCemsTypeDef";
    private static DefData excludeAQDTypeDefData;
    private boolean tradeSecretAllowed;
    public static final String MEMO = "25";
    ...
    public static DefData getData() {
        ...
        if (data == null) {
            data = new DefData();
            data.loadFromDB("ComplianceReportSQL.retrieveCemsAttachmentTypes", 
                    ComplianceAttachmentCemsTypeDef.class);
