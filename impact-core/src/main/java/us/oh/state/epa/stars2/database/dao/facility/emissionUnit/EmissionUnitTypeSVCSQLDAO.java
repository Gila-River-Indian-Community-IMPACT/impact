...
@Repository
public class EmissionUnitTypeSVCSQLDAO extends EmissionUnitTypeSQLDAO implements
		EmissionUnitTypeDAO {
	...
	public EmissionUnitType createEmissionUnitType(EmissionUnitType euType)
		...
		ConnectionHandler connHandler = new ConnectionHandler(
				"EmissionUnitTypeSQL.createEmissionUnitTypeSVC", false);

		int i = 1;
		connHandler.setInteger(i++, euType.getEmuId());
		connHandler.setString(i++, euType.getEquipmentType());
		connHandler.setString(i++, euType.getEquipmentTypeOther());
		connHandler.setString(i++, euType.getSolventType());
