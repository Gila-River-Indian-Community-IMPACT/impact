...
public class ComplianceAttachmentOtherTypeDef extends SimpleDef {
    private static final String defName = "ComplianceAttachmentOtherTypeDef";
    private static DefData excludeAQDTypeDefData;
    private boolean tradeSecretAllowed;
    public static final String MEMO = "45";
    ...
    public static DefData getData() {
        ...
        if (data == null) {
            data = new DefData();
            data.loadFromDB("ComplianceReportSQL.retrieveOtherAttachmentTypes", 
                    ComplianceAttachmentOtherTypeDef.class);
