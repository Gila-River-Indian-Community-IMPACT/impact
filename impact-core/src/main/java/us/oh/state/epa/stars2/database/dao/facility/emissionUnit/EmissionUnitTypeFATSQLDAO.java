...
@Repository
public class EmissionUnitTypeFATSQLDAO extends EmissionUnitTypeSQLDAO implements
		EmissionUnitTypeDAO {
	...
	public EmissionUnitType createEmissionUnitType(EmissionUnitType euType)
		...
		ConnectionHandler connHandler = new ConnectionHandler(
				"EmissionUnitTypeSQL.createEmissionUnitTypeFAT", false);
		...
		connHandler.setString(i++, euType.getUnitTypeOther());
		connHandler.update();
