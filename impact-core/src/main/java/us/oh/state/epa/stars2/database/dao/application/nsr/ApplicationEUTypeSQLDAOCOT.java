...
import us.oh.state.epa.stars2.database.dao.ApplicationEUTypeDAOCOT;
import us.oh.state.epa.stars2.database.dbObjects.application.nsr.NSRApplicationEUType;
import us.oh.state.epa.stars2.database.dbObjects.application.nsr.NSRApplicationEUTypeCOT;
import us.oh.state.epa.stars2.framework.exception.DAOException;

@Repository
public class ApplicationEUTypeSQLDAOCOT extends ApplicationEUTypeSQLDAO
		implements ApplicationEUTypeDAOCOT {
	...
	public NSRApplicationEUType retrieveApplicationEUType(Integer appEuId)
			throws DAOException {
		NSRApplicationEUTypeCOT ret = new NSRApplicationEUTypeCOT();
		return ret;
	}
