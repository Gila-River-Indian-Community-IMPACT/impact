...
//Emissions Inventory Attachment Type Defs
public class EmissionsAttachmentTypeDef extends SimpleDef {
    
    public static final String OTHER = "20";
    private static final String defName = "EmissionsAttachmentTypeDef";
    ...
    public static DefData getData() {
        ...
        if (data == null) {
            data = new DefData();
            data.loadFromDB("EmissionsReportSQL.retrieveReportAttachmentTypes", EmissionsAttachmentTypeDef.class);
