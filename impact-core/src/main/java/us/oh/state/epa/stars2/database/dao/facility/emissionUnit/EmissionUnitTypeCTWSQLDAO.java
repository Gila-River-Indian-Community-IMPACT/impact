...
@Repository
public class EmissionUnitTypeCTWSQLDAO extends EmissionUnitTypeSQLDAO implements
		EmissionUnitTypeDAO {
	...
	public EmissionUnitType createEmissionUnitType(EmissionUnitType euType)
		...
		ConnectionHandler connHandler = new ConnectionHandler(
				"EmissionUnitTypeSQL.createEmissionUnitTypeCTW", false);

		int i = 1;
		connHandler.setInteger(i++, euType.getEmuId());
		connHandler.setFloat(i++, euType.getDriftRate());
		connHandler.setBigDecimal(i++, euType.getDissolvedSolidsTotal());
