...
<f:view>
  <af:document id="body" onmousemove="#{infraDefs.iframeResize}"
    onload="#{infraDefs.iframeReload}" title="Edit Enforcement Action Attachment">
    <f:verbatim>
        ...
        <f:facet name="footer">
          <af:panelButtonBar>
            ...
            <af:commandButton text="Save"
              rendered="#{!attachments.newAttachment}"
              disabled="#{attachments.locked || !enforcementActionDetail.enforcementActionEditAllowed}"
