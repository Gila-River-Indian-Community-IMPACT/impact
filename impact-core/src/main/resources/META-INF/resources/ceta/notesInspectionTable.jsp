...
<af:table id="INSPComments" width="98%"
	rows="5" emptyText=" " var="dc"
	value="#{fceDetail.fce.inspectionNotes}">
	...
	<af:column headerText="Note ID" sortable="true" width="10%"
		...
		<af:panelHorizontal valign="middle" halign="left">
			<af:commandLink text="#{dc.noteId}" id="viewNote" useWindow="true"
				...
				action="#{fceDetail.startEditComment}">
				<t:updateActionListener property="#{fceDetail.modifyComment}"
					value="#{dc}" />
			</af:commandLink>
		</af:panelHorizontal>
	</af:column>
		...
		<afh:rowLayout halign="center">
			<af:panelButtonBar>
				<af:commandButton text="Add Note" id="AddButton" useWindow="true"
					windowWidth="650" windowHeight="300"
					rendered="#{!fceDetail.readOnlyUser}"
					action="#{fceDetail.startAddComment}" />
