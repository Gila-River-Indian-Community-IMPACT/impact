...
<af:table id="siteVisitComments" width="98%"
	rows="5" emptyText=" " var="dc"
	value="#{siteVisitDetail.siteVisit.siteVisitNotes}">
	...
	<af:column headerText="Note ID" sortable="true" width="10%"
		...
		<af:panelHorizontal valign="middle" halign="left">
			<af:commandLink text="#{dc.noteId}" id="viewNote" useWindow="true"
				...
				action="#{siteVisitDetail.startEditComment}">
				<t:updateActionListener property="#{siteVisitDetail.modifyComment}"
					value="#{dc}" />
			</af:commandLink>
		</af:panelHorizontal>
	</af:column>
		...
		<afh:rowLayout halign="center">
			<af:panelButtonBar>
				<af:commandButton text="Add Note" id="AddButton" useWindow="true"
					windowWidth="650" windowHeight="300"
					rendered="#{!siteVisitDetail.readOnlyUser}"
					action="#{siteVisitDetail.startAddComment}" />
