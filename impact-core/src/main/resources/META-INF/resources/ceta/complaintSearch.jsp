...
<f:view>
	<af:document title="Monthly Complaints">
		<f:verbatim>
		...
		<af:form>
			<af:page var="foo" value="#{menuModel.model}"
						...
						<af:panelForm rows="1" maxColumns="2">
							...
							<af:panelForm rows="3" maxColumns="1">
								<af:selectOneChoice label="DO/LAA"
									value="#{complaintSearch.doLaaCd}" unselectedLabel="">
								...
								<afh:rowLayout halign="center">
									<af:panelButtonBar>
										<af:commandButton text="Submit"
											action="#{complaintSearch.search}">
										</af:commandButton>
										<af:commandButton text="testSubmit" rendered="false"
											action="#{complaintSearch.testSubmit}">
										</af:commandButton>
									</af:panelButtonBar>
								</afh:rowLayout>
							</af:panelForm>
				...
				<afh:rowLayout halign="center">
					<h:panelGrid border="1" width="1000"
						rendered="#{complaintSearch.hasSearchResults}">
						<af:showDetailHeader text="Complaint List" disclosed="true">
							<jsp:include flush="true" page="complaintSearchTable.jsp" />
						</af:showDetailHeader>
					</h:panelGrid>
				</afh:rowLayout>
			</af:page>
