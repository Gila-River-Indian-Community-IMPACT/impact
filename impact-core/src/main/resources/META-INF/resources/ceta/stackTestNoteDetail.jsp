...
<f:view>
	<af:document title="Add Note">
		...
		<af:form usesUpload="true">
			...
			<af:panelForm>
				<af:inputText value="#{stackTestDetail.tempComment.noteTxt}"
					label="Note: " readOnly="#{stackTestDetail.noteReadOnly}" columns="80"
					...
					<afh:rowLayout halign="center">
						<af:panelButtonBar>
							<af:commandButton text="Save"
								rendered="#{!stackTestDetail.noteReadOnly}"
								actionListener="#{stackTestDetail.saveComment}" />
							<af:commandButton text="Cancel"
								rendered="#{!stackTestDetail.noteReadOnly}"
								actionListener="#{stackTestDetail.closeViewDoc}" />
