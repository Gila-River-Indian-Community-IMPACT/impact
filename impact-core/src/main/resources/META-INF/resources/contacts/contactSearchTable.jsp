...
<afh:rowLayout halign="center">
	<h:panelGrid border="1" rendered="#{contactSearch.hasSearchResults}">
		<af:panelBorder>
			<af:showDetailHeader text="Contact List" disclosed="true">

				<af:table value="#{contactSearch.resultsWrapper}"
					binding="#{contactSearch.resultsWrapper.table}" bandingInterval="1"
					banding="row" var="contact" rows="#{contactSearch.pageLimit}">
