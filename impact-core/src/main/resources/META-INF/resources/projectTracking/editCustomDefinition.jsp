...
<f:view>
  ...
  <af:form usesUpload="true">
     ...
     <f:subview id="defList">             
      <af:panelForm>
		<af:outputText value="#{projectTrackingDefCatalog.label}" />
	  </af:panelForm> 
      
      <af:forEach var="record" varStatus="vsi" items="#{projectTrackingDefCatalog.customRecord.cells}">           
	      <af:panelForm>
	      	...
	      	<af:inputText 
			    ...
			    readOnly="#{record.readOnly && !projectTrackingDefCatalog.newCustomRecord}" 
			    tip="Number"  
          ...
          <afh:rowLayout halign="center">           
           <af:panelButtonBar>
            <af:commandButton text="Save"
                actionListener="#{projectTrackingDefCatalog.saveCustom}"/>
