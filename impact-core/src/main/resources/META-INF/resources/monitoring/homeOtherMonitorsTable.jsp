...
<af:table value="#{homeMonitorSiteDetail.otherMonitorsWrapper}" bandingInterval="1"
	binding="#{homeMonitorSiteDetail.otherMonitorsWrapper.table}" id="OtherMonitorsTab"
