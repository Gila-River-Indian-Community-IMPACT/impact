...
<af:panelBox background="light" width="1000px">
  <af:panelForm rows="1" maxColumns="3">
      ...
      value="#{homeMonitorReportDetail.monitorReport.mrptId}" />
    <af:inputText label="Monitor Group ID: " readOnly="true"
      value="#{homeMonitorReportDetail.monitorGroupId}" />
    <af:selectOneChoice label="Submitted: " readOnly="true"
      rendered="#{!homeMonitorReportDetail.publicApp}"
      value="#{homeMonitorReportDetail.monitorReport.submitted}">
