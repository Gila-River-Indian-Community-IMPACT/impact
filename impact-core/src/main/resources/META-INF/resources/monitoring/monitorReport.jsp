							...
							<afh:rowLayout halign="center">
								<af:panelButtonBar>
									...
									<af:commandButton text="Close"
										rendered="#{!monitorReportDetail.editable && !monitorReportDetail.fromTODOList}"
										action="#{monitorReportDetail.close}" />
									<af:commandButton text="Delete"
										...
										returnListener="#{monitorReportDetail.deleteReport}"
										action="#{confirmWindow.confirm}">
							              ...
							              <t:updateActionListener
							                ...
							                value="Click Yes to confirm the deletion of monitor report #{monitorReportDetail.monitorReport.mrptId}"/>
							         </af:commandButton>       
									...
									<af:commandButton text="Submit"
										...
										action="#{monitorReportDetail.submitReport}" />	
									<af:commandButton text="Submit"
										rendered="#{monitorReportDetail.submitAllowed && monitorReportDetail.portalApp}"
										disabled="#{!myTasks.impactFullEnabled || !myTasks.hasSubmit}"
										action="#{monitorGroupDetail.submitReports}"
										returnListener="#{monitorReportDetail.closeDialog}"
										useWindow="true"
										...
										<t:updateActionListener property="#{submitTask.task}"
											value="#{monitorGroupDetail.reportsTask}"/>
									</af:commandButton>			
								</af:panelButtonBar>
							</afh:rowLayout>
