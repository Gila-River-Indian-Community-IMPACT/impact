...
<af:table value="#{homeMonitorGroupDetail.notesWrapper}" bandingInterval="1"
	binding="#{homeMonitorGroupDetail.notesWrapper.table}" id="NotesTab"
	...
	<af:column sortProperty="c01" sortable="true" formatType="text"
		...
		<af:commandLink text="#{note.noteId}" id="viewNote" useWindow="true"
			...
			action="#{homeMonitorGroupDetail.startViewNote}">
			<t:updateActionListener property="#{homeMonitorGroupDetail.modifyNote}"
				value="#{note}" />
		</af:commandLink>
	</af:column>
		...
		<afh:rowLayout halign="center">
			<af:panelButtonBar>
				<af:commandButton text="Add Note" id="AddNoteButton"
					...
					disabled="false" returnListener="#{homeMonitorGroupDetail.dialogDone}"
					rendered="true" action="#{homeMonitorGroupDetail.startAddNote}">
				</af:commandButton>
