...
<af:panelForm rows="1" maxColumns="2" labelWidth="150" width="600">
    ...
    <af:selectOneChoice id="unitCd" label="Units:"
        ...
        showRequired="true">
        <f:selectItems
            value="#{facilityReference.oepMaxAnnualThroughputUnitsDefs.items[(empty facilityProfile.emissionUnit.emissionUnitType.unitCd ? '' : facilityProfile.emissionUnit.emissionUnitType.unitCd)]}" />
    </af:selectOneChoice>
</af:panelForm>
