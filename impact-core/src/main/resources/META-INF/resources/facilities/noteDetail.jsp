		...
		<af:form usesUpload="true">
			...
			<af:panelForm>
				<af:inputText id="noteTxt" label="Note: " rows="10"
					value="#{facilityProfile.facilityNote.noteTxt}" columns="80"
					maximumLength="4000" readOnly="#{facilityProfile.readOnlyNote}"
				...
				<f:facet name="footer">
					<af:panelButtonBar>
						<af:commandButton text="Save"
							disabled="#{facilityProfile.disableNoteButton}"
							rendered="#{facilityProfile.editable1}"
							actionListener="#{facilityProfile.applyEditNote}" />
						<af:commandButton text="Cancel"
							rendered="#{facilityProfile.editable1}" immediate="true"
							action="#{facilityProfile.cancelEditNote}" />
						<af:commandButton text="Edit"
							disabled="#{facilityProfile.disableNoteButton}"
							rendered="#{!facilityProfile.editable1}"
							actionListener="#{facilityProfile.startEditNote}" />
