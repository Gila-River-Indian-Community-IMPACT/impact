...
<af:panelForm rows="1" maxColumns="2" labelWidth="150" width="600">
	<af:selectOneChoice id="unitType" label="Unit Type:"
		...
		showRequired="true">
		<f:selectItems
			value="#{facilityReference.ckdUnitTypeDef.items[(empty facilityProfile.emissionUnit.emissionUnitType.unitType ? '' : facilityProfile.emissionUnit.emissionUnitType.unitType)]}" />
	</af:selectOneChoice>
</af:panelForm>

<af:panelForm rows="1" maxColumns="2" labelWidth="150" width="600">
	<af:inputText id="maximumThroughput" label="Maximum Annual Throughput:"
		readOnly="#{! facilityProfile.editable}"
	...
	<af:selectOneChoice id="Units" label="Units:"
		...
		showRequired="true">
		<f:selectItems
			value="#{facilityReference.ckdMaxAnnualThroughputUnitsDefs.items[(empty facilityProfile.emissionUnit.emissionUnitType.unitCd ? '' : facilityProfile.emissionUnit.emissionUnitType.unitCd)]}" />
	</af:selectOneChoice>
</af:panelForm>
