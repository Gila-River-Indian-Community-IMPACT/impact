...
<af:panelBox background="light" width="100%" rendered="#{!facilityProfile.portalApp}">
...
<afh:rowLayout halign="center">
<af:outputFormatted rendered="#{(myTasks.facility.endDate != null)}" inlineStyle="color: orange; font-weight: bold;" value="<b>** Historical version. Please note the facility inventory version start and end dates. **</b>"/>
</afh:rowLayout>
