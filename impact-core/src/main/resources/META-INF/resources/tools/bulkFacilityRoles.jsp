  ...
  <af:document title="Facilities - Bulk Operations">
      ...
      <afh:rowLayout halign="center">        
        <h:panelGrid border="1" columns="1" width="400">            	
          <af:panelBorder>            	
            <af:panelHeader text="Change Facility Role" size="0" />
            <af:panelForm>

              <af:selectOneChoice value="#{bulkOperationsCatalog.bulkOperation.userIdForRole}"
                  readOnly="#{!bulkOperationsCatalog.bulkOperation.facilityRoleEditable}"
                  label="#{bulkOperationsCatalog.bulkOperation.role.facilityRoleDsc}" >
