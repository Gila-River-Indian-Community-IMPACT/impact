		...
		<af:panelBorder>
			<af:showDetailHeader text="Facility List" disclosed="true">
				...
				<af:table value="#{bulkOperationsCatalog.facilities}"
					...
					<af:column sortProperty="processId" sortable="true" formatType="text"
						rendered="#{bulkOperationsCatalog.taskOperation}"
						headerText="Task Id">
						<af:outputText
							value="#{facility.processId}-#{facility.activityTemplateId}-#{facility.loopCnt}" />
					</af:column>
					<af:column sortProperty="activityTemplateNm" sortable="true" formatType="text"
						rendered="#{bulkOperationsCatalog.taskOperation}"
						headerText="Task Name">
						<af:outputText value="#{facility.activityTemplateNm}" />
					</af:column>
					<af:column sortProperty="userId" sortable="true" formatType="text"
						rendered="#{bulkOperationsCatalog.taskOperation}"
						headerText="Staff Name">
						<af:selectOneChoice value="#{facility.userId}" readOnly="true">
							<f:selectItems value="#{infraDefs.basicUsersDef.allItems}" />
						</af:selectOneChoice>
					</af:column>
					<af:column sortProperty="roleCd" sortable="true" formatType="text"
						rendered="#{bulkOperationsCatalog.roleOperation}"
