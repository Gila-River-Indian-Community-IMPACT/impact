  ...
  <af:document id="body" onmousemove="#{infraDefs.iframeResize}" onload="#{infraDefs.iframeReload}" title="Permits Documents">
      ...
      <af:panelForm>
		...
		<af:goLink id="documentLink"
			  text="Monthly Timesheet Report"
              destination="#{timesheetEntry.monthlyReport.report.generatedDocumentPath}"
              targetFrame="_blank" />
        
        <af:outputText
          value="Select the above link to download a document to save"/> 
        ...
        <f:facet name="footer">
          <af:panelButtonBar>
            <af:commandButton text="Cancel" immediate="true"
              action="#{timesheetEntry.cancelDownload}">
            </af:commandButton>
          </af:panelButtonBar>
        </f:facet>
