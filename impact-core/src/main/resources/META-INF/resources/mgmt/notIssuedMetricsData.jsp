...
<afh:rowLayout halign="center">
  <h:panelGrid border="1" width="#{issuedMetrics.width}"
    rendered="#{issuedMetrics.hasNotIssuedSearchResults}">
    <af:panelBorder>
      <af:showDetailHeader text="Not Issued Metrics Report" disclosed="true">
        <af:table bandingInterval="1" banding="row" var="details"
          emptyText='No Applications in Queue'
          rows="#{issuedMetrics.pageLimit}" width="99%"
          value="#{issuedMetrics.notIssuedDetails}">
...
<%--
 ...
 --%>         
          ...
          <af:column sortProperty="permitGlobalStatus" sortable="true"
            headerText="Publication Stage">
            <af:panelHorizontal valign="middle" halign="left">
              <af:selectOneChoice unselectedLabel=" " readOnly="true"
                value="#{details.permitGlobalStatus}">
                <mu:selectItems value="#{issuedMetrics.permitGlobalStatusDefs}" />
              </af:selectOneChoice>
            </af:panelHorizontal>
          </af:column>
          ...
          <af:column sortProperty="permitActionType" sortable="true"
            headerText="Action">
            <af:panelHorizontal valign="middle" halign="left">
              <af:outputText value="#{details.permitActionTypeDesc}" />
            </af:panelHorizontal>
          </af:column>
