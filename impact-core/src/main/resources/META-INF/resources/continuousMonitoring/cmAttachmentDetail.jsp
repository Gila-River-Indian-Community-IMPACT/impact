...
<f:view>
	<af:document id="body" onmousemove="#{infraDefs.iframeResize}"
		onload="#{infraDefs.iframeReload}" title="Edit Monitor Attachment">
		<f:verbatim>
		...
		<af:form usesUpload="true">
			<af:messages />
			<af:panelForm
				partialTriggers="reportType attachmentWarningMsg tradeSecretFile"
				maxColumns="2" width="600" labelWidth="160">
				...
				<af:selectOneChoice id="reportType" showRequired="true"
					label="Attachment Type :" rendered="#{attachments.hasDocType}"
				...
				<af:inputText id="descriptionText"
					readOnly="#{attachments.locked && !attachments.newAttachment}"
					showRequired="true" label="Description :" maximumLength="500"
					disabled="#{!continuousMonitorDetail.continuousMonitorEditAllowed}"
				...
				<f:facet name="footer">
					<af:panelButtonBar>
						...
						<af:commandButton text="Save"
							rendered="#{!attachments.newAttachment}"
							disabled="#{attachments.locked || !continuousMonitorDetail.continuousMonitorEditAllowed}"
