...
<f:view>
  <af:document id="body" title="Delete Emissions Unit Group">
      ...
      <af:page>
        ...
        <af:panelForm>
          ...
          <af:panelGroup layout="vertical">
            <af:outputText
              value="All data associated with this emissions unit group will be 
          ...
          <f:facet name="footer">
            <af:panelButtonBar>
              <af:commandButton text="Yes"
                actionListener="#{applicationDetail.deleteTvEuGroup}" />
