					...
					<af:table id="offsetAdjustments" 
						...
						<af:column id="rowId" formatType="text" headerText="Row Id"
							...
							<af:panelHorizontal valign="middle" halign="left">
								<af:commandLink 
									useWindow="true" windowWidth="750" windowHeight="700"
									inlineStyle="padding-left:5px;"
									action="#{companyProfile.startToViewEmissionsOffsetAdjustment}">
						...
						<af:column id="nonAttainmentAreaCd" headerText="Non-Attainment Area" width="12%"
							...
							<af:panelHorizontal valign="middle" halign="left">
								<af:selectOneChoice label="Non-Attainment Area"
									readOnly="true" value="#{offsetAdjustment.nonAttainmentAreaCd}">
									<f:selectItems
						...
						<af:column id="date" headerText="Date" width="8%"
							...
							<af:panelHorizontal valign="middle" halign="left">
								<af:selectInputDate label="Date"
									readOnly="true" value="#{offsetAdjustment.date}" />
							</af:panelHorizontal>
						</af:column>
						...
						<af:column id="includeInTotal" headerText="Include in Total (Y/N)" width="5%"
							sortable="true" sortProperty="includeInTotal" formatType="text">
							<af:panelHorizontal valign="middle" halign="left">
								<af:selectOneChoice
									label="Include in Total (Y/N)" readOnly="true"
									value="#{offsetAdjustment.includeInTotal}">
						...
						<f:facet name="footer">
							<afh:rowLayout halign="center">
								<af:panelGroup layout="horizontal">
									<af:commandButton text="Add Emissions Offset Adjustment"
										rendered="#{infraDefs.stars2Admin || userAttrs.NSRAdminUser}"
										useWindow="true" windowWidth="750"	windowHeight="700"
										inlineStyle="padding-left:5px;"
										action="#{companyProfile.startToAddEmissionsOffsetAdjustment}" />
