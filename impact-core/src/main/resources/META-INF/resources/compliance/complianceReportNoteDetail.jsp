...
<f:view>
	<af:document title="Add Note">
		...
		<af:form usesUpload="true">
			...
			<af:panelForm>
				<af:inputText value="#{complianceReport.tempNote.noteTxt}" showRequired="true"
					label="Note: " readOnly="#{complianceReport.noteReadOnly}" columns="80"
					...
					<afh:rowLayout halign="center">
						<af:panelButtonBar>
							<af:commandButton text="Save"
								rendered="#{!complianceReport.noteReadOnly}"
								actionListener="#{complianceReport.saveNote}" />
							<af:commandButton text="Cancel"
								rendered="#{!complianceReport.noteReadOnly}"
								actionListener="#{complianceReport.cancelEditNote}" />
							<af:commandButton text="Close"
								rendered="#{complianceReport.noteReadOnly}"
								actionListener="#{complianceReport.closeViewNote}" />
						</af:panelButtonBar>
					</afh:rowLayout>
				</f:facet>
			</af:panelForm>
