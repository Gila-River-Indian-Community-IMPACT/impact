    ...
    <af:form>
      ...
      <af:panelForm>
        ...
        <af:inputText label="Description :" required="true"
          disabled="#{!((permitDetail.singleDoc.permitDocTypeCD == 'NPA' || permitDetail.singleDoc.permitDocTypeCD == 'CCLF') 
          					&& permitDetail.permit.permitType == 'TVPTO' ? permitDetail.semiEditAllowed : permitDetail.editAllowed)}"	
        ...
        <f:facet name="footer">
          <af:panelButtonBar>
            ...
            <af:commandButton text="Delete" id="delButton"
              disabled="#{!permitDetail.attachDocDelAble || 
              				!((permitDetail.singleDoc.permitDocTypeCD == 'NPA' || permitDetail.singleDoc.permitDocTypeCD == 'CCLF') 
          					&& permitDetail.permit.permitType == 'TVPTO' ? permitDetail.semiEditAllowed : permitDetail.editAllowed)}"
