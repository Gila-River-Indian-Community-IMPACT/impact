      ...
      <f:facet name="eu">
        <h:panelGroup>
          <af:commandMenuItem action="#{permitDetail.nodeClicked}"
            ...
            onclick="if (#{permitDetail.editMode}) { alert('Please save or discard your changes'); return false; }">
            <t:graphicImage border="0" value="#{permitDetail.currentFacility.permitClassCd == 'tv' &&
                        !(empty node.userObject.fpEU.tvClassCd) && 
                         (node.userObject.fpEU.tvClassCd == 'ins' || node.userObject.fpEU.tvClassCd == 'innr' ||  node.userObject.fpEU.tvClassCd == 'trv') ? 
                        (node.userObject.fpEU.tvClassCd == 'ins' ||  node.userObject.fpEU.tvClassCd == 'trv' ? 
                        	(node.userObject.fpEU.tvClassCd == 'ins' ? '/images/insignificantEU.gif' : 
                        		'/images/trivialEU.gif') : 
