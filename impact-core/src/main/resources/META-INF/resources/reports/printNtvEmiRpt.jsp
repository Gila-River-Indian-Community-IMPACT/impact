		...
		<af:form usesUpload="true">
			<af:messages />
				...
				<af:table id="pribtableDocumentsTable"
					value="#{erNTVDetail.reportDocuments}" bandingInterval="1"
				...
				<af:outputText
					...
					rendered="#{erNTVDetail.reportAttachments != null}" />

				<af:table id="pribtableAttachmentsTable"
					rendered="#{erNTVDetail.reportAttachments != null}"
					value="#{erNTVDetail.reportAttachments}" bandingInterval="1"
					width="100%" banding="row" var="printableDocument">
					<af:column sortable="true" formatType="text"
						headerText="Document Description">
						<af:goLink id="documentLink"
				...
				<af:outputText
					value="Select a link in the above table to view or download a document to print." />
