...
<f:view>
  ...
  <af:form usesUpload="true">
     ...
     <f:subview id="defList">             
      <af:panelForm>
		<af:outputText value="#{reportsDefCatalog.label}" />
	  </af:panelForm> 
      
      <af:forEach var="record" varStatus="vsi" items="#{reportsDefCatalog.customRecord.cells}">           
	      <af:panelForm>
	      	...
	      	<af:inputText 
			    ...
			    readOnly="#{record.readOnly && !reportsDefCatalog.newCustomRecord}" 
			    tip="Number"  
          ...
          <afh:rowLayout halign="center">           
           <af:panelButtonBar>
            <af:commandButton text="Save"
                actionListener="#{reportsDefCatalog.saveCustom}"/>
