 ...
 * 
 */
@WebServiceClient(name = "Lists", targetNamespace = "http://schemas.microsoft.com/sharepoint/soap/", wsdlLocation = "http://apollo/sites/DefaultCollection/TestProject/_vti_bin/Lists.asmx?WSDL")
public class Lists
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://apollo/sites/DefaultCollection/TestProject/_vti_bin/Lists.asmx?WSDL");
