 ...
 * 
 */
@WebServiceClient(name = "Copy", targetNamespace = "http://schemas.microsoft.com/sharepoint/soap/", wsdlLocation = "http://apollo/sites/DefaultCollection/TestProject/_vti_bin/Copy.asmx?WSDL")
public class Copy
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://apollo/sites/DefaultCollection/TestProject/_vti_bin/Copy.asmx?WSDL");
